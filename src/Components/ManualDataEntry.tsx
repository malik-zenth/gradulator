        ...
        return (
            <div>
                <Card title="Manuelle Noteneingabe" extra={<a onClick={() => this.props.setStateofInstruction()}>Anleitung</a>} bordered={false} headStyle={{padding: 0}} bodyStyle={{paddingLeft: 0, paddingRight: 0}}>
                    <p>Gerade den Notenspiegel nicht parat? <FontAwesomeIcon icon={faFrown}/> Lasse deinen Notendurchschnitt berechnen, indem du manuell deine aktuellen Noten eingibst. Hinweis: Auch unvollständige Notenspiegel können berechnet werden.</p>
                </Card>
            </div>
        )
    }
